...
public class _05_FacebookTest extends Base {
    ...
    public void validateFacebookLoginForm(){
        ...
        WebElement createNewAccountButton = driver.findElement(By.cssSelector("a[id^= 'u_0_0']"));
        ...
        Assert.assertTrue(createNewAccountButton.isEnabled());
        Assert.assertEquals(createNewAccountButton.getText(),"Create new account");
        Assert.assertFalse(createNewAccountButton.getAttribute("href").isEmpty());
  ...
  */
    ...
    public void validateFacebookInvalidLoginAttempt(){
        ...
        usernameInputBox.sendKeys("askdfasfasdf@gmail.com");
        ...
        /*
         error message webElement must come after clicking login button
         so when you put in invalid info an error message comes up
         */
